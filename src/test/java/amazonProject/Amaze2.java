...
public class Amaze2 {
	...
	public void amazonCartTest() {
		...
		// First product text
		String text = driver.findElement(By.xpath("(//span[@class='a-size-medium a-color-base a-text-normal'])[1]"))
				.getText();
		...
		String text1 = driver.findElement(By.xpath("(//span[@class='a-truncate-cut'])[5]")).getText();
